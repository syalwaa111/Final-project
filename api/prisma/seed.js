...
async function main() {
  ...
  const asya = await prisma.job_category.upsert({
    where: { id_job_category: 1 }, 
    update: {},
    create: {
      nama_category: 'Category 1',
      jobId: {
        create: [
          {
          pekerjaan_terdahulu: 'Software Engineer',
          perusahaan_terdahulu: 'TechCorp',
          tahun_mulai: new Date('2020-01-01'),
          tahun_selesai: new Date('2022-01-01'),
          pengalaman_kerja: 'Full Stack Developer',
          keahlian: 'JavaScript, React, Node.js',
          },
        ],
      },
    },
  ...
  console.log({ alice, bob, xyla, asya})
